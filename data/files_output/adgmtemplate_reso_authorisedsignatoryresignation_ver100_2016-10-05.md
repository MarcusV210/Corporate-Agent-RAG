...
**[RESIGNATION OF AUTHORISED SIGNATORY]{.underline}**

IT WAS NOTED, that [{insert name}]{.mark} had resigned as authorised
signatory of the Company.

IT WAS THEREFORE RESOLVED that the resignation [{insert name}]{.mark} as
authorised signatory of the Company be and is hereby accepted with
effect from [{insert effective date of appointment}.]{.mark}
